...
namespace Holding.Base.Infrastructure.Helpers
{
    public static class PersianDateTimeHelper
    {
        ...
        public static int FaMonthOfYear(this DateTime? src)
        {
            if (src == null)
                return 0;
            return FaMonthOfYear(src.Value);
        }
        ...
        {
            return String.Format("{0}/{1:d2}/{2:d2}", PersianCalendar.GetYear(src), PersianCalendar.GetMonth(src),
                PersianCalendar.GetDayOfMonth(src));
        }
        ...
        public static string FaWeekDayName(this DateTime? src)
        {
            if (src == null)
                return null;
            return FaWeekDayName(src.Value);
        }
