...
namespace Holding.Base.SOA.SeedWorks.Core
{
    public class ApiClientConfigurationExpression
    {
        ...
        public ApiClientConfigurationExpression SetCredentialsFromAppSetting( string affiliateKeyAppSettingKey , string usernameAppSettingKey , string passwordAppSettingKey )
        {
            ...
            var affiliateKey = ConfigurationManager.AppSettings[ affiliateKeyAppSettingKey ];
            ...
            {
                throw new ArgumentException( string.Format( "The application setting '{0}' does not exist or its value is null." , affiliateKeyAppSettingKey ) );
            }

            if ( string.IsNullOrEmpty( username ) )
            {
                throw new ArgumentException( string.Format( "The application setting '{0}' does not exist or its value is null." , usernameAppSettingKey ) );
            }
