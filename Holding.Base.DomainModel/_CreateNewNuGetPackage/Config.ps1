...
# a.najafi:
# مقدار ورژن زیر را خالی بگذارید تا ورژنی که در فایل 
# AssemblyInfo
# برای پروژه تعریف شده است به عنوان پکیج نیز بکار برده شود.
$versionNumber = ""
# $versionNumber = "1.0.0.10"
...
# پروژه فقط روی حالت ریلییز نوگت میسازد
